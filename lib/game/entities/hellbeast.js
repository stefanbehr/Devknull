...
.defines(function() {
	EntityHellbeast = ig.Entity.extend({
		...
		init: function(x, y, settings) {
			...
			this.weapon = ig.game.spawnEntity('EntityHellbeastWeapon', this.pos.x, this.pos.y, {owner:this});
			// Add animations
		...
		tryFollowingPlayer: function(player) {
			...
			if (player) {
				...
				if ((enemyDist <= this.followRadius) && (enemyDist > this.stopRadius)) {
					...
					var xneighborhood, yneighborhood;
					xneighborhood = (Math.abs(this.pos.x - px) < 8);
					yneighborhood = (Math.abs(this.pos.y - py) < 8);
				...
				if (enemyDist <= this.attackRadius) {
					if (enemyDist > stopRadius) {
						this.activeWeapon = 'fireball';
						this.stopped = false;
					} else {
					...
					// within some neighborhood of xaligned or yaligned
					if (xneighborhood || yneighborhood) {
						// shoot fireball. will add timing later.
						this.attacking = true;
					}
				}
			}
    ...
    EntityHellbeastWeapon = ig.Entity.extend({
        ...
        update: function(settings) {
            ...
            if (this.weaponType == 'sword' && this.attacking) {
            	...
            	this.currentAnim = this.anims.fireball;
            }
        ...
        checkAttack: function() {
            ...
            if (this.weaponType == 'fireball' && ig.input.pressed('attack')) {
                this.attacking = false;
                this.attackTimer = 0;
                this.hasHit = false;
                ig.game.spawnEntity('EntityFireball', this.owner.pos.x, this.owner.pos.y, {dir:this.owner.direction, owner:this.owner});
            }
         },
...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Devknull/lib/game/entities/hellbeast.js at master · stefanbehr/Devknull</title>
...
<meta content="4Ae1OBnp7hx5MJ3+PIZO40VbWE3+TKx5GKuMTDooFk4=" name="csrf-token" />
    ...
    <script defer="defer" src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-9892ca69b1d6743cc42c1db653e5102a152511ad.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/stefanbehr/Devknull/blob/130f668ba2f00faa25fe0b356ce8b4dcb44be61d/lib/game/entities/hellbeast.js'>
            ...
            <div class="js-filter-tab js-filter-branches" data-filterable-for="context-commitish-filter-field">
              <div class="no-results js-not-filterable">Nothing to show</div>
                <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/stefanbehr/Devknull/blob/master/lib/game/entities/hellbeast.js" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
            </div>
...
<!-- block_view_fragment_key: views8/v8/blob:v21:b91d20301a7a2c65cadefc86518907e1 -->
  <div id="slider">
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="lib/game/entities/hellbeast.js/" data-permalink-url="/stefanbehr/Devknull/blob/130f668ba2f00faa25fe0b356ce8b4dcb44be61d/lib/game/entities/hellbeast.js" data-title="Devknull/lib/game/entities/hellbeast.js at master · stefanbehr/Devknull · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter js-rewrite-sha" href="/stefanbehr/Devknull/edit/130f668ba2f00faa25fe0b356ce8b4dcb44be61d/lib/game/entities/hellbeast.js" data-method="post" rel="nofollow" data-hotkey="e"><span>Edit this file</span></a>
                  </li>

                <li>
                  <a href="/stefanbehr/Devknull/raw/master/lib/game/entities/hellbeast.js" class="minibutton btn-raw grouped-button bigger lighter" id="raw-url"><span><span class="icon"></span>Raw</span></a>
                </li>
                  <li>
                    <a href="/stefanbehr/Devknull/blame/master/lib/game/entities/hellbeast.js" class="minibutton btn-blame grouped-button bigger lighter"><span><span class="icon"></span>Blame</span></a>
                  </li>
                <li>
                  <a href="/stefanbehr/Devknull/commits/master/lib/game/entities/hellbeast.js" class="minibutton btn-history grouped-button bigger lighter" rel="nofollow"><span><span class="icon"></span>History</span></a>
                </li>
              </ul>
            </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span title="0.28877s from fe11.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.29191' data-host='fe11'></span>
  </body>
</html>

>>>>>>> 15491b6c69f8b4f5a67f3502a3aa859cb8d22cb3

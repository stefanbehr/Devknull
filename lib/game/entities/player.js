...
/*        weaponDisplacements: {
		...
		setupAnimation: function(dir) {
            ...
            this.addAnim('idle', 1, [offset]);
            var swingseq = [offset-1, offset, offset+1, offset+1, offset, offset-1];
            if (left) {
            	swingseq = swingseq.reverse();
            }
            this.addAnim('swing', 2, swingseq);
        ...
        checkAttack: function() {
            if (this.weaponType == 'sword') {
                ...
                } else if (ig.input.pressed('attack') && this.attacking) {

...
EntityHud = ig.Entity.extend({
    ...
    healthBar: [new ig.Image('media/r_bar_top.png'), new ig.Image('r_bar_med.png'), new ig.Image('r_bar_bottom.png')],
    expBar: [new ig.Image('media/g_bar_top.png'), new ig.Image('g_bar_med.png'), new ig.Image('g_bar_bottom.png')],
